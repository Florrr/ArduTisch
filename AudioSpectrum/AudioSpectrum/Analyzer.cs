...
namespace AudioSpectrum
{
    ...
    internal class Analyzer
    {
        ...
        private int _lines = 2;            // number of spectrum lines
        private int _sendline = 0;
        ...
        public void setLines(int lines_number, int lines_selected) {
            _lines = lines_number;
            _sendline = lines_selected;
        }
        ...
        static string ConvertStringArrayToStringJoin(byte[] array) {
            //
